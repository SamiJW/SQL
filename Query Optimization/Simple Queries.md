...
CREATE TABLE BOOKS (
    ...
    BOOK_TITLE VARCHAR2 (180) NOT NULL,
    BOOK_DESCRIPTION VARCHAR2 (250),
...
CREATE TABLE BOOK_CATEGORY (
    ...
    BOOK_CATEGORY_DESCRIPTION VARCHAR2 (500)
);
CREATE TABLE ORDERS (
...
<img width="819" height="997" alt="BookstoreERD drawio" src="https://github.com/user-attachments/assets/5ba53b94-e8ab-40ec-ad3c-ff5189f2889e" />
